            ...
            <div class="card-body">
                <form class="form-item" action="" method="post" role="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="noktp" placeholder="Silahkan isi no KTP" required="required">
                    </div>
                    <div class="form-group">
                        <label for="nama">Nama Lengkap</label>
                        <input type="text" class="form-control" name="namalengkap" placeholder="Nama Lengkap" required="required">
                    </div>
                    <div class="form-group">
                        <label for="nohp">Nomor HP</label>
                        <input type="number" class="form-control" name="nohp" placeholder="No Hp" required="required">
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" name="alamat" placeholder="Isikan alamat" required="required"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="kota">Kota Asal</label>
                        <input type="text" class="form-control" name="kota" placeholder="Kota asal" required="required">
                    </div>
                    <div class="form-group">
                        <label for="tmptlahir">Tempat Lahir</label>
                        <input type="text" class="form-control" name="tmptlahir" placeholder="Tempat lahir" required="required">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pekerjaan" placeholder="Jenis pekerjaan" required="required">
                    </div>
