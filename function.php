...
function tambahdatanasabah($data)
{
  ...
  $query = "INSERT INTO nasabah (noktp,nama,nohp,alamat,kota,tmptlahir,tgllahir,penghasilan,pekerjaan) VALUES ('$noktp','$namalengkap','$nohp','$alamat','$kota','$tmptlahir','$tgllahir','$penghasilan','$pekerjaan')";
  mysqli_query($link, $query);
  return mysqli_affected_rows($link);
}
